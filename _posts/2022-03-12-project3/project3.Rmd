...
description: |
  An output created for my Advanced Data Analysis class using non-linear least squared to create a model that estimates the parameters of a length to weight model for the lizard populations on New Mexico.
author:
